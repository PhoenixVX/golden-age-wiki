# Generation Layer Sequence *(b1.8)*

## Preview
![](/assets/genlayer/b18.gif)
...
flowchart TD
    ...
    Seed: 2"]
    addIsland2-->zoom2002["Zoom
    Seed: 2002"]
    zoom2002-->addIsland3["Add Island
    Seed: 3"]
    addIsland3-->zoom2003["Zoom
    Seed: 2003"]
    zoom2003-->addIsland3_1["Add Island
    Seed: 3"]
    addIsland3_1-->zoom2004["Zoom
    Seed: 2004"]
    zoom2004-->addIsland3_2["Add Island
    Seed: 3"]

    addIsland3_2-->zoom1000x0["Zoom
    Levels: 0
    Seed: 1000"]
    ...
    addIsland3_2-->zoom1000x0_1["Zoom
    Levels: 0
    Seed: 1000"]
    ...
    ieq0-->|No|biomeStub
    ieq0-->|Yes|addIsland3_3["Add Island
    Seed: 3"]
    addIsland3_3-->biomeStub[Biome]
